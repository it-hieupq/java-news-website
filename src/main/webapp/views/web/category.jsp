        ...
        <div id="content">
            <div class="content-header">
                <div class="content-header-top">
                    ...
                    <a class ="active" href="${pageContext.request.contextPath}/category?id=${category.id}">${category.name }</a>
                </div>
                <div class="content-header-bottom">
                    <p class="" style="margin: 10px 0;"><b>${category.description } </b></p>
                </div>
            </div>
            <div class="content-main">
                ...
                <div class="older-news">
                    ...
                    <div class="col2">
                    	...
                    	<c:if test="${ relateArticle!=null && fn:length(relateArticle) > 0 }">
                    
                        <div class="breaking-news">
                        
                            <div class = "news-header">
                                <a href="#">TIÊU ĐIỂM - ${category.name }</a>
                            </div>
                                	...
                                	<c:forEach items="${relateArticle}" var="item" varStatus="status">
                                		...
                                		<c:if test="${status.index==0 }">
		                                    ...
		                                    <li>
		                                        <div class="img">
													<a href="${pageContext.request.contextPath}/article?id=${item.id }">
		                                                <img alt=${item.title } src="<c:url value='/${item.thumnail }'/>">
		                                            </a>
		                                        </div>
		                                        <div class="title">
		                                            <a href="${pageContext.request.contextPath}/article?id=${item.id }">
