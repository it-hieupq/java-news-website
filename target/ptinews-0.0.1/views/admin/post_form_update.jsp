			...
			<div>
				...
				<div class="container">
					...
					<form action="<c:url value='/admin/articles'/>?action=edit&id=${article.id}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>Content</label>
							<textarea rows="20" cols="110" name="content" class="form-control" id="content">
								${ article.content }
							</textarea>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" value="${ article.thumnail }" type="file" name="thumnail" />
						</div>
						...
						<div class="form-check">
							<c:if test = "${article.event=='checked' }">
								<input type="checkbox" class="form-check-input" checked="checked" value="checked" name="event">
							</c:if>
							<c:if test = "${article.event=='unchecked' }">
								<input type="checkbox" class="form-check-input" value="checked" name="event">
							</c:if>
